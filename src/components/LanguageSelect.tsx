...
export const LanguageSelect = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#F4F4F2] text-[#1A1A1A] sm:border-8 sm:border-[#1A1A1A] p-4 relative z-10 w-full animate-fade-in" dir="ltr">
      <img src="/logo.jpeg" alt="Mantak Logo" className="w-24 sm:w-40 mb-4 sm:mb-8 object-contain drop-shadow-[6px_6px_0px_#FF3B30] sm:drop-shadow-[8px_8px_0px_#FF3B30]" />
      <h1 className="text-4xl sm:text-7xl font-black mb-2 sm:mb-4 uppercase tracking-tight text-center">Mantak <span className="text-[#FF3B30] text-2xl sm:text-5xl align-top block sm:inline mt-2 sm:mt-0">v4.0</span></h1>
