export const translations = {
  fa: {
    ...
    offlineWarning: "توجه: شما آفلاین هستید. بررسی کاملاً آفلاین و بر اساس قواعد پایه‌ای انجام شد. برای بررسی دقیق هوش مصنوعی به اینترنت متصل شوید.",
  ...
  en: {
    ...
    offlineWarning: "Note: You are offline. The analysis was performed completely offline using basic heuristics. Connect to the internet for deep AI reasoning.",
